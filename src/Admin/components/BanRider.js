...
const BanRider = ({ userEmail, historyID }) => {
	...
	const onSubmit = () => {
		// axios
		//   .delete(`https://ahride.herokuapp.com/getHistoryDelete/${historyID}/`)
		//   .then((response) => {
		//     console.log(response);
		//   });
		//   axios
		//   .delete(`https://ahride.herokuapp.com/getRiderUser/delete/${user}/`)
		//   .then((response) => {
		//     console.log(response);
		//   });
		...
		axios
			.all([
				axios.delete(
					`https://ahride.herokuapp.com/getHistoryDelete/${historyID}/`
				),
				axios.delete(
					`https://ahride.herokuapp.com/getRiderUser/delete/${user}/`
				),
			])
			.then((responseArr) => {
